...
* **feat-docker:** add ollama specific make target and docker compose ([9ed84f2](https://github.com/ZanzyTHEbar/mcp-memory-libsql-go/commit/9ed84f2813d7ceac3b6643f6e4d7ad9928ede833))
